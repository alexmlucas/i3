...
class mydsp : public dsp {
 ...
 public:
  ...
  void metadata(Meta* m) { 
    ...
    m->declare("filename", "Plucked_Violin.dsp");
  ...
  virtual void instanceConstants(int sample_rate) {
    ...
    fConst6 = (0.00110294123f * fConst0);
  ...
  virtual void buildUserInterface(UI* ui_interface) {
    ui_interface->openVerticalBox("Plucked_Violin");
  ...
  virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
    ...
    for (int i = 0; (i < count); i = (i + 1)) {
      ...
      fRec23[0] = (((((fRec2[((IOTA - (iTemp4 + 1)) & 2047)] * fTemp7) * fTemp9) * fTemp11) * fTemp13) + (fTemp14 * ((((((fRec2[((IOTA - (iTemp15 + 1)) & 2047)] * fTemp16) * fTemp17) * fTemp18) + (0.5f * (((fTemp6 * fRec2[((IOTA - (iTemp19 + 1)) & 2047)]) * fTemp20) * fTemp21))) + (0.166666672f * ((fTemp22 * fRec2[((IOTA - (iTemp23 + 1)) & 2047)]) * fTemp24))) + (0.0416666679f * (fTemp25 * fRec2[((IOTA - (iTemp26 + 1)) & 2047)])))));
      ...
      fVec0[0] = (((((fRec30[((IOTA - (iTemp30 + 2)) & 2047)] * fTemp33) * fTemp35) * fTemp37) * fTemp39) + (fTemp40 * ((((((fRec30[((IOTA - (iTemp41 + 2)) & 2047)] * fTemp42) * fTemp43) * fTemp44) + (0.5f * (((fTemp32 * fRec30[((IOTA - (iTemp45 + 2)) & 2047)]) * fTemp46) * fTemp47))) + (0.166666672f * ((fTemp48 * fRec30[((IOTA - (iTemp49 + 2)) & 2047)]) * fTemp50))) + (0.0416666679f * (fTemp51 * fRec30[((IOTA - (iTemp52 + 2)) & 2047)])))));
      iRec32[0] = ((1103515245 * iRec32[1]) + 12345);
      float fTemp53 = std::tan((fConst8 / fTemp0));
      float fTemp54 = (1.0f / fTemp53);
      float fTemp55 = (((fTemp54 + 1.41421354f) / fTemp53) + 1.0f);
      fRec31[0] = ((4.65661287e-10f * float(iRec32[0])) - (((fRec31[2] * (((fTemp54 + -1.41421354f) / fTemp53) + 1.0f)) + (2.0f * (fRec31[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp53)))))) / fTemp55));
      fVec1[0] = fSlow2;
      iRec33[0] = ((fSlow2 > fVec1[1]) + ((fSlow2 <= fVec1[1]) * (iRec33[1] + (iRec33[1] > 0))));
      float fTemp56 = (float(iRec33[0]) / std::max<float>(1.0f, (fConst9 * mydsp_faustpower2_f((1.0f - (0.170000002f / fTemp0))))));
      float fTemp57 = (fSlow1 * (((fRec31[2] + (fRec31[0] + (2.0f * fRec31[1]))) * std::max<float>(0.0f, std::min<float>(fTemp56, (2.0f - fTemp56)))) / fTemp55));
      fVec2[0] = (fVec0[1] + fTemp57);
      fRec28[(IOTA & 2047)] = ((0.25f * fRec28[((IOTA - 1) & 2047)]) + (0.75f * fVec2[1]));
      float fRec25 = (((((fTemp7 * fTemp9) * fTemp11) * fTemp13) * fRec28[((IOTA - iTemp4) & 2047)]) + (fTemp14 * ((((((fTemp16 * fTemp17) * fTemp18) * fRec28[((IOTA - iTemp15) & 2047)]) + (0.5f * (((fTemp6 * fTemp20) * fTemp21) * fRec28[((IOTA - iTemp19) & 2047)]))) + (0.166666672f * ((fTemp22 * fTemp24) * fRec28[((IOTA - iTemp23) & 2047)]))) + (0.0416666679f * (fTemp25 * fRec28[((IOTA - iTemp26) & 2047)])))));
      fRec20[0] = fRec24;
      float fRec21 = (fTemp57 + fRec20[1]);
      float fRec22 = fRec25;
      fRec17[(IOTA & 2047)] = fRec21;
      float fRec18 = (((((fTemp33 * fTemp35) * fTemp37) * fTemp39) * fRec17[((IOTA - (iTemp30 + 1)) & 2047)]) + (fTemp40 * ((((((fTemp42 * fTemp43) * fTemp44) * fRec17[((IOTA - (iTemp41 + 1)) & 2047)]) + (0.5f * (((fTemp32 * fTemp46) * fTemp47) * fRec17[((IOTA - (iTemp45 + 1)) & 2047)]))) + (0.166666672f * ((fTemp48 * fTemp50) * fRec17[((IOTA - (iTemp49 + 1)) & 2047)]))) + (0.0416666679f * (fTemp51 * fRec17[((IOTA - (iTemp52 + 1)) & 2047)])))));
      fRec19[0] = fRec22;
      fRec16[0] = fRec19[1];
      fRec14[0] = (fRec16[1] - (fConst10 * ((fConst11 * fRec14[2]) + (fConst12 * fRec14[1]))));
      float fTemp58 = ((fConst4 * fRec14[0]) + (fConst13 * fRec14[2]));
  ...
  #define FAUST_FILE_NAME "Plucked_Violin.dsp"
  ...
  FAUST_ADDHORIZONTALSLIDER("gain", fHslider1, 0.5f, 0.0f, 1.0f, 0.01f);
  FAUST_ADDBUTTON("gate", fButton0);

  #define FAUST_LIST_ACTIVES(p) \
    p(HORIZONTALSLIDER, freq, "freq", fHslider0, 660.0f, 660.0f, 1100.0f, 0.01f) \
    p(HORIZONTALSLIDER, gain, "gain", fHslider1, 0.5f, 0.0f, 1.0f, 0.01f) \
    p(BUTTON, gate, "gate", fButton0, 0.0, 0.0, 1.0, 1.0) \
...
Plucked_Violin::Plucked_Violin() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void Plucked_Violin::updateImp(void)
{
#if MIDICTRL
...
void Plucked_Violin::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void Plucked_Violin::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float Plucked_Violin::getParamValue(const std::string& path)
{
